...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="es"><body className={manrope.variable}><LocalAuthCompat/><ClinicalStatusSync/><PatientProfileCompat/><AestheticHistoryCompat/>{children}</body></html>}